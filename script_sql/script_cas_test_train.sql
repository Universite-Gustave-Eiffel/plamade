...
UPDATE DEM SET THE_GEOM=ST_AddZ(THE_GEOM, 0.0);
DROP TABLE IF EXISTS RAIL_BUFFER;


DROP TABLE IF EXISTS BDTOPO_RAIL;

CREATE TABLE BDTOPO_RAIL AS SELECT ST_Force3D(a.THE_GEOM) THE_GEOM, a.LARGEMPRIS, b.* FROM RAIL_SECTIONS_TEST a, PLATEFORM b WHERE b.IDPLATFORM ='SNCF';
...
UPDATE BDTOPO_RAIL SET THE_GEOM=ST_AddZ(THE_GEOM, 0.5);
