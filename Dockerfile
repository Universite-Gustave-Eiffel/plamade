...
ENTRYPOINT ["sh", "-c", "exec /srv/noisemodelling/bin/WebServer -b -w /srv/noisemodelling/workspace -s /srv/noisemodelling/scripts ${PROXY_BASE_URL:+-l \"$PROXY_BASE_URL\"} ${ROOT_URL+-r \"$ROOT_URL\"} ${UNSECURE_MODE+-u}"]
