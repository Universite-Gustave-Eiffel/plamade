...
package org.noise_planet.covadis.scripts.Acoustic_Tools
...
description = 'Generate isolines (isophones) by linear interpolation on triangle edges (marching-triangles).' +
              ...
              '</br> </br> <b> Main output table : ISOLINES_NOISE_MAP </b> ' +
              'with : </br>' +
              ...
              '</br> </br> <b> Additional output tables </b> : one table per PERIOD, ' +
              'named <code>L&lt;PERIOD&gt;_ISOLINES_NOISE_MAP</code>, ' +
...
def exec(Connection connection, Map input, ProgressVisitor progress) {
    ...
    // Print results
    // -------------------
    List<String> periodTables = periods.findAll { it != null }
