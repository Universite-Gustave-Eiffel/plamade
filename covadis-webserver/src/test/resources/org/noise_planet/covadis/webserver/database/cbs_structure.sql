...
CREATE INDEX ON cbs_uge_input.c_batiment_s_hexa USING GIST (geom3d);
...
CREATE TABLE bd_alti.d028 (
	...
	CONSTRAINT pk_d028 PRIMARY KEY (id)
);
...
CREATE TABLE bd_alti.d078 (
	id int4 NOT NULL,
	the_geom public.geometry(pointz, 2154) NULL,
	CONSTRAINT pk_d078 PRIMARY KEY (id)
);
...
CREATE TABLE cbs_uge_input.n_ferroviaire_troncon_l (
	...
	ido varchar(32) NULL,
	idf varchar(32) NULL,
	homogene varchar(2) NULL,
	idligne varchar(32) NULL,
	numligne varchar(50) NULL,
	prdeb varchar(8) NULL,
	prfin varchar(8) NULL,
	shape_leng numeric NULL,
	largempris numeric NULL,
	nb_voies numeric NULL,
	rampe numeric NULL,
	vmaxinfra float8 NULL,
	cbs_gitt varchar(1) NULL,
	basevoie varchar(1) NULL,
	rugosite varchar(1) NULL,
	semelle varchar(1) NULL,
	protectsup varchar(1) NULL,
	jointrail varchar(1) NULL,
